...
public class GoldDustItem extends TeufoxAdditionsModElements.ModElement {
	@ObjectHolder("teufox_additions:gold_dust")
	public static final Item block = null;
	public GoldDustItem(TeufoxAdditionsModElements instance) {
		super(instance, 33);
	}
