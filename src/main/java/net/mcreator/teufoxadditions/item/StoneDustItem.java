...
public class StoneDustItem extends TeufoxAdditionsModElements.ModElement {
	@ObjectHolder("teufox_additions:stone_dust")
	public static final Item block = null;
	public StoneDustItem(TeufoxAdditionsModElements instance) {
		super(instance, 30);
	}
