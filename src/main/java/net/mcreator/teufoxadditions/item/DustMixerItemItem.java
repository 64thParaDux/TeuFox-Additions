...
import net.mcreator.teufoxadditions.gui.DustMixerGui;
...
public class DustMixerItemItem extends TeufoxAdditionsModElements.ModElement {
	@ObjectHolder("teufox_additions:dust_mixer_item")
	public static final Item block = null;
	public DustMixerItemItem(TeufoxAdditionsModElements instance) {
		super(instance, 36);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof DustMixerGui.GuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(FloofyTabItemGroup.tab).maxStackSize(1).rarity(Rarity.COMMON));
			setRegistryName("dust_mixer_item");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Mix dust and a slow way of making dust."));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Dust Mixer Item");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new DustMixerGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
