...
public class NetheriteDustItem extends TeufoxAdditionsModElements.ModElement {
	@ObjectHolder("teufox_additions:netherite_dust")
	public static final Item block = null;
	public NetheriteDustItem(TeufoxAdditionsModElements instance) {
		super(instance, 34);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Used in dust mixer."));
		}
	}
}
