...
public class QuartzDustItem extends TeufoxAdditionsModElements.ModElement {
	@ObjectHolder("teufox_additions:quartz_dust")
	public static final Item block = null;
	public QuartzDustItem(TeufoxAdditionsModElements instance) {
		super(instance, 35);
	}
