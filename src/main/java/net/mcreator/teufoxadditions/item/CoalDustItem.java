...
public class CoalDustItem extends TeufoxAdditionsModElements.ModElement {
	@ObjectHolder("teufox_additions:coal_dust")
	public static final Item block = null;
	public CoalDustItem(TeufoxAdditionsModElements instance) {
		super(instance, 32);
	}
