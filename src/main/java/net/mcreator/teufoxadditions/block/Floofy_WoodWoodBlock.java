...
public class Floofy_WoodWoodBlock extends TeufoxAdditionsModElements.ModElement {
	@ObjectHolder("teufox_additions:floofy_wood_wood")
	public static final Block block = null;
	public Floofy_WoodWoodBlock(TeufoxAdditionsModElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("floofy_wood_wood");
		}
