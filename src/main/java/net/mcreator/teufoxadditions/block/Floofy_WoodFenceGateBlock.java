...
public class Floofy_WoodFenceGateBlock extends TeufoxAdditionsModElements.ModElement {
	@ObjectHolder("teufox_additions:floofy_wood_fence_gate")
	public static final Block block = null;
	public Floofy_WoodFenceGateBlock(TeufoxAdditionsModElements instance) {
		super(instance, 8);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("floofy_wood_fence_gate");
		}
