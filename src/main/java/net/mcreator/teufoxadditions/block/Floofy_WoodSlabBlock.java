...
public class Floofy_WoodSlabBlock extends TeufoxAdditionsModElements.ModElement {
	@ObjectHolder("teufox_additions:floofy_wood_slab")
	public static final Block block = null;
	public Floofy_WoodSlabBlock(TeufoxAdditionsModElements instance) {
		super(instance, 6);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("floofy_wood_slab");
		}
