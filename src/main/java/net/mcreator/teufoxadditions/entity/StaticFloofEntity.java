...
package net.mcreator.teufoxadditions.entity;
...
import net.mcreator.teufoxadditions.procedures.StaticFloofOnInitialEntitySpawnProcedure;
import net.mcreator.teufoxadditions.procedures.StaticFloofItIsStruckByLightningProcedure;
import net.mcreator.teufoxadditions.particle.SparksParticle;
...
public class StaticFloofEntity extends TeufoxAdditionsModElements.ModElement {
	public static EntityType entity = null;
	@ObjectHolder("teufox_additions:entitybulletstatic_floof")
	public static final EntityType arrow = null;
	public StaticFloofEntity(TeufoxAdditionsModElements instance) {
		super(instance, 39);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(128).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1f, 1f)).build("static_floof")
						.setRegistryName("static_floof");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -205, -26368, new Item.Properties().group(FloofyTabItemGroup.tab))
				.setRegistryName("static_floof_spawn_egg"));
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
				.size(0.5f, 0.5f)).build("entitybulletstatic_floof").setRegistryName("entitybulletstatic_floof"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (!biomeCriteria)
				continue;
			biome.getSpawns(EntityClassification.AMBIENT).add(new Biome.SpawnListEntry(entity, 20, 2, 8));
		}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> new MobRenderer(renderManager, new GhastModel(), 0.5f) {
			...
			public ResourceLocation getEntityTexture(Entity entity) {
				return new ResourceLocation("teufox_additions:textures/puffle.png");
			}
		});
		RenderingRegistry.registerEntityRenderingHandler(arrow,
				renderManager -> new SpriteRenderer(renderManager, Minecraft.getInstance().getItemRenderer()));
	}
	public static class CustomEntity extends TameableEntity implements IRangedAttackMob, IAnimatedEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new FollowOwnerGoal(this, 2, (float) 10, (float) 3, false));
			this.goalSelector.addGoal(2, new OpenDoorGoal(this, true));
			this.goalSelector.addGoal(3, new OpenDoorGoal(this, false));
			this.goalSelector.addGoal(4, new SwimGoal(this));
			this.goalSelector.addGoal(5, new TemptGoal(this, 2, Ingredient.fromItems(new ItemStack(Items.BLAZE_ROD, (int) (1)).getItem()), false));
			this.goalSelector.addGoal(6, new OwnerHurtByTargetGoal(this));
			this.goalSelector.addGoal(7, new BreedGoal(this, 2));
			...
			this.goalSelector.addGoal(12, new LeapAtTargetGoal(this, (float) 3));
			this.goalSelector.addGoal(13, new MeleeAttackGoal(this, 0, false));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Items.GLOWSTONE_DUST, (int) (1)));
		}

		@Override
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.note_block.chime"));
		}

		@Override
		public void playStepSound(BlockPos pos, BlockState blockIn) {
			this.playSound((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.note_block.pling")),
					0.15f, 1);
		}
		...
		public void onStruckByLightning(LightningBoltEntity entityLightningBolt) {
			...
			Entity entity = this;
			{
				...
				StaticFloofItIsStruckByLightningProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public ILivingEntityData onInitialSpawn(IWorld world, DifficultyInstance difficulty, SpawnReason reason, ILivingEntityData livingdata,
			...
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				StaticFloofOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (new ItemStack(Items.BLAZE_ROD, (int) (1)).getItem() == stack.getItem())
				return true;
			return false;
		}
		...
		public void livingTick() {
			...
			if (true)
				for (int l = 0; l < 4; ++l) {
					...
					world.addParticle(SparksParticle.particle, d0, d1, d2, d3, d4, d5);
				}
		}
	}
