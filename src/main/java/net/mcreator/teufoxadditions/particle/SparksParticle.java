...
package net.mcreator.teufoxadditions.particle;
...
public class SparksParticle extends TeufoxAdditionsModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public SparksParticle(TeufoxAdditionsModElements instance) {
		super(instance, 39);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("sparks"));
	}
